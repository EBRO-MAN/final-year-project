...
SECRET_KEY = 'django-insecure-)4-as^)3c&_4u)a3yi*ep-)@5%df1c7#a@5af^a*4=bo_^8r*c'
...
SESSION_ENGINE = 'django.contrib.sessions.backends.db'  # or 'django.contrib.sessions.backends.signed_cookies'
